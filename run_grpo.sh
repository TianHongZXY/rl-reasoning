...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='MATH-Qwen2.5-7B-GRPO-cosine_reward' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=5 \
    trainer.total_epochs=40 \
    reward_model.reward_type="cosine" $@
    # trainer.experiment_name='MATH-Qwen2.5-7B-GRPO_correct_ratio_under_0.0_filtered_questions-cosine_reward' \
    # data.train_files=/p/llmresearch/thh9bk/verl/data/math-Qwen2.5-7B-correct_ratio_under_0.0_filtered_questions/train.parquet \
